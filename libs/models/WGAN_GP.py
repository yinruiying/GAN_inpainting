...
class WGAN_GP(object):
    ...
    def train(self):
        ...
        optimizerD = optim.RMSprop(self.D.parameters(), lr=self.lrD)
        optimizerG = optim.RMSprop(self.G.parameters(), lr=self.lrG)
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, (x_, _) in enumerate(dataloader, 0):
                ...
                x_hat = alpha * real_cpu.data + (1 - alpha) * fake.data
        ...
        for i, image in enumerate(images):
            ...
            for iteration in range(cfgs.num_iters+1):
                ...
                if iteration % 5000 == 0:
                    ...
                    total_loss = 10*loss_context + cfgs.lamd * loss_perceptual
